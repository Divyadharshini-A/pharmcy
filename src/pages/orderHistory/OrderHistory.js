        ...
        <MDBCard style={{borderRadius:"10px"}}>
          <MDBCardHeader className='px-4 py-5'>
            <MDBTypography tag = "h5" className='text-muted mb-0'>
              ...
              <span style={{color:"#a8729a"}}>Customer</span>
            </MDBTypography>
          </MDBCardHeader>
            ...
            <MDBCard className='shadow-0 border mb-4'>
              <MDBCardBody>
                <MDBRow>
                  <MDBCol md = "2">
                  <MDBCardImage
                            src="https://www.mmm-online.com/wp-content/uploads/sites/2/2018/07/ofev_717103-860x683.jpg"
                            fluid
                            alt="Phone"
                          />
                  </MDBCol>
                        ...
                        >
                         <p className="text-muted mb-0">Ofex capsules</p>  
                </MDBCol>
                ...
                <MDBCol
                          ...
                          className="text-center d-flex justify-content-center align-items-center"
                        >
                          <p className="text-muted mb-0 small">Rupess 3400/-</p>
                        </MDBCol>
                </MDBRow>
                <hr
                        className="mb-4"
                ...
                <MDBCol md = "10">
                  <MDBProgress style={{ height: "6px", borderRadius: "16px"}}>
                    <MDBProgressBar style={{borderRadius:"16px",backgroundColor:"#a8729a",}}
                    width={65}
                    valuemin={0}
                    valuemax={100}
                    />
            ...
            <MDBCard className='shadow-0 border mb-4'>
              <MDBCardBody>
                <MDBRow>
                  <MDBCol md="2">
                  <MDBCardImage
                            src="https://www.ultragenyx.com/wp-content/uploads/2021/06/med-bottles.png"
                            fluid
                            alt="Phone"
                          />
                    </MDBCol>
                    <MDBCol md="2" className='text-center d-flex justify-content-center align-items-center'>
                    <p className="text-muted mb-0">Dojolvi oral liquid</p>
                    </MDBCol>
                    <MDBCol
                          md="2"
                          className="text-center d-flex justify-content-center align-items-center"
                        >
                          <p className="text-muted mb-0 small">Oral medicine</p>
                        </MDBCol>
                        <MDBCol
                          md="2"
                          className="text-center d-flex justify-content-center align-items-center"
                ...
                <MDBRow className='align-items-center'>
                <MDBCol md="2">
                          <p className="text-muted mb-0 small"><b></b></p>
                        </MDBCol>
                        <MDBCol md="10">
                          <MDBProgress
